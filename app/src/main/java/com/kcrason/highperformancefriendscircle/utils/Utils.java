...
public class Utils {
    ...
    {
        final float scale = FriendsCircleApplication.sContext.getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
       // return (int) 1;
                //TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, FriendsCircleApplication.sContext.getResources().getDisplayMetrics());
    }
